...
function SocialIcons() {
  return (
         <Col xl={12} className="social-icons">
          ...
          <a href="https://github.com/Ayaabuyousef" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.linkedin.com/in/aya-abuyousef-672358158/" target="_blank" rel="noopener noreferrer">
